...
--
-- Name: task_1; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.task_1 (
    id integer NOT NULL,
...
--
-- Name: task_1_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.task_1_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.task_1_id_seq OWNER TO postgres;

--
-- Name: task_1_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.task_1_id_seq OWNED BY public.task_1.id;
...
--
-- Name: task_1 id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.task_1 ALTER COLUMN id SET DEFAULT nextval('public.task_1_id_seq'::regclass);
...
--
-- Data for Name: task_1; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.task_1 (id, name, pwd, email, gender) FROM stdin;
...
--
-- Name: task_1_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.task_1_id_seq', 6, true);
...
--
-- Name: task_1 task_1_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.task_1
    ADD CONSTRAINT task_1_pkey PRIMARY KEY (id);
